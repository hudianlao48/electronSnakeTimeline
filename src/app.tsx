...
export async function getInitialState(): Promise<{ name: string, imageSourceList: any }> {
  return {
    name: '拾光',
    imageSourceList: [
      ...
      { value: 'snakemobile', label: '故纸堆（移动版）', desc: '所有图源的聚合版' },
      { value: 'glutton', label: '周度精选', desc: '拾光官方维护，周度精选' },
      { value: 'gluttonmobile', label: '周度精选（移动版）', desc: '拾光官方维护，周度精选' },
